...
class MandatoryQuestionnaireRequest(BaseModel):
	...
	age: str = Field(..., description="Age", min_length=1, max_length=10)

	# Location Information
	city: str = Field(..., description="City", min_length=1, max_length=100)
	country: str = Field(..., description="Country", min_length=1, max_length=100)

	# Personal Information
	marital_status: str = Field(..., description="Marital status", min_length=1, max_length=50)
	occupation: str = Field(..., description="Occupation", min_length=1, max_length=100)
	education: str = Field(..., description="Education", min_length=1, max_length=100)
	employment_status: str = Field(..., description="Employment status", min_length=1, max_length=50)
